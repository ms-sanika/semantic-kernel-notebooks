...
public static class Settings
{
    ...
    {
        var (useAzureOpenAI, model, azureEndpoint, apiKey) = ReadSettings(_useAzureOpenAI, configFile);
        ...
        WriteSettings(configFile, useAzureOpenAI, model, azureEndpoint, apiKey);
    ...
    public static (bool useAzureOpenAI, string model, string azureEndpoint, string apiKey)
        LoadFromFile(string configFile = DefaultConfigFile)
    {
        ...
        try
        {
            ...
            return (useAzureOpenAI, model, azureEndpoint, apiKey);
        }
        catch (Exception e)
        {
    ...
    private static (bool useAzureOpenAI, string model, string azureEndpoint, string apiKey)
        ReadSettings(bool _useAzureOpenAI, string configFile)
    {
        ...
        try
        {
            if (File.Exists(configFile))
            {
                (useAzureOpenAI, model, azureEndpoint, apiKey) = LoadFromFile(configFile);
            }
        }
        catch (Exception e)
        {
    ...
    private static void WriteSettings(
        string configFile, bool useAzureOpenAI, string model, string azureEndpoint, string apiKey)
    {
        try
        {
